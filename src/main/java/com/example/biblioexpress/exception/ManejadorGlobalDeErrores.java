 ...
 *
 * @RestControllerAdvice intercepta las excepciones de controllers/services y
 * arma una respuesta JSON uniforme con el codigo HTTP correcto. Asi el codigo
 * de negocio solo tira excepciones y no arma respuestas de error.
 */
...
public class ManejadorGlobalDeErrores {
    ...
    /** Falla una validacion @NotBlank / @Positive de un DTO. */
