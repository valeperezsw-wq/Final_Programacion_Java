 ...
 * UNIDAD 4 - HASHMAP.
 *
 * Guarda los materiales en un HashMap<codigo, Material>.
 * Por que HashMap y no List: buscar por codigo es O(1), no hay que recorrer.
 * El codigo es unico -> encaja como clave.
 *
 * @Repository: capa de acceso a datos; Spring crea una unica instancia
 * compartida (por eso los datos persisten mientras corre la app).
 */
@Repository
