...
public class SocioService {
    ...
    /**
     * Recibe una lista de DNIs (con repetidos y/o basura) y devuelve solo los
     * unicos, recorriendo la lista UNA sola pasada.
     *
     * Como funciona el HashSet:
     *  - set.add(x) devuelve true si x NO estaba (y lo agrega),
     *    o false si x YA estaba.
     *  - En una sola vuelta: si add() da true -> primera aparicion -> lo sumo;
     *    si da false -> duplicado -> lo salteo.
     *  - Buscar "ya lo vi?" en HashSet es O(1). Con List seria O(n^2) total.
     *
